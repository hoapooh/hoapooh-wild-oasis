...
function prepareData(startData, stays) {
	...
	// The startData is used for the arr and the confirmedStays is used for the cur
	// down below the num is used to determine the duration of the stay
	// and then it is passed with the corresponding value like '1 night' or '2 nights' or '3 nights' etc.
	const data = stays
		.reduce((arr, cur) => {
